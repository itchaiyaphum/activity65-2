...
class Executivereport_model extends BaseModel
{
    public $table = null;
    ...
    {
        $filter_semester = $this->ci->input->get_post('executive_filter_semester');
        $filter_major = $this->ci->input->get_post('executive_filter_major');
        $filter_type = $this->ci->input->get_post('executive_filter_type');
