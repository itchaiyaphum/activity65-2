<div class="uk-container uk-container-center">
	<div class="uk-grid">
		...
		<div class="tm-main uk-width-medium-3-4 uk-margin-top uk-margin-bottom">
			<form action="<?php echo base_url('headadvisor/approving');?>" method="post" name="adminForm" class="uk-form">
				...
				<div class="uk-text-center">
					<select name="headadvisor_filter_week" onchange="document.adminForm.submit();">
						<option value="">- กรุณาเลือกสัปดาห์ -</option>
						<?php
                            foreach ($filter_weeks as $week) {
                                ?>
							<option value="<?php echo $week->id; ?>" <?php echo set_select('headadvisor_filter_week', $week->id); ?>>สัปดาห์ที่ <?php echo $week->name; ?></option>
						<?php
                            }
                        ?>
					</select>
					<select name="headadvisor_filter_major" onchange="document.adminForm.submit();">
						<option value="">- กรุณาเลือกสาขาวิชา -</option>
						<?php
                            foreach ($filter_majors as $major) {
                                ?>
							<option value="<?php echo $major->id; ?>" <?php echo set_select('headadvisor_filter_major', $major->id); ?>>สาขาวิชา: <?php echo $major->name; ?></option>
						<?php
                            }
                        ?>
					</select>
