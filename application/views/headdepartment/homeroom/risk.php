	...
	<div class="uk-grid">
		...
		<div class="tm-main uk-width-medium-3-4 uk-margin-top uk-margin-bottom">
			...
			<div class="uk-grid uk-grid-small">
				...
				<a  class="uk-button uk-margin-small-bottom uk-width-small-1-1 uk-width-medium-1-1 uk-width-large-1-4 uk-button-primary" href="<?php echo base_url("headdepartment/homeroom/risk/?id=".$homeroom->id."&group_id=".$group_id);?>">STEP 3: ประเมินความเสี่ยง</a>
                			...
                			<tr>
								...
								<td>
									<div class="uk-grid uk-grid-small">
										...
										<div class="uk-width-small-7-10">
											<textarea class="uk-width-small-1-1" name="student_items[<?php echo $student->id; ?>][detail]"><?php echo $student->risk_detail; ?></textarea>
										</div>
									</div>
                				</td>
                				<td>
									<div class="uk-grid uk-grid-small">
										...
										<div class="uk-width-small-7-10">
										<textarea class="uk-width-small-1-1" name="student_items[<?php echo $student->id; ?>][comment]"><?php echo $student->risk_comment; ?></textarea>
										</div>
									</div>
                				</td>
                				<td>
