                ...
                <?php foreach ($semester->groups as $group) { ?>
                    <div class="uk-panel uk-panel-box uk-panel-box-default uk-margin-top uk-overflow-container">
                        ...
                        <div class="uk-panel-badge">
                            <a href="<?= site_url('headdepartment/summaryhomeroom/report') . '?id=' . $group->id.'&semester='.$semester->id ?>" target="_blank"><button type="button" class="uk-button uk-button-primary uk-button-mini submit"><i class="uk-icon-print"></i> Print</button></a>
                        </div>
                        <hr>
